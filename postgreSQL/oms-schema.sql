...
DROP FUNCTION IF EXISTS get_order_items_with_variants(uuid);
...
-- Customer cycling functions
DROP FUNCTION IF EXISTS add_customer_with_cycling(varchar, text, varchar, varchar, text, text);
